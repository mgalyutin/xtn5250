...
public class XITelnet implements AutoCloseable {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(XITelnet.class.getName());
            ...
            case SIAC_WCMD:
                ...
                switch (bb) {
                    ...
                    case SE:
                        ...
                        LOGGER.debug("SE {}", TELOPT[ivIACOpt]);
    ...
    public synchronized void sendIACCmd(byte aCmd, byte aOpt) {
        LOGGER.debug(" t " + aCmd + " " + TELCMD[-(aCmd + 1)] + " " +
                TELOPT[aOpt]);
    ...
    public synchronized void sendIACStr(byte aCmd, byte aOpt, boolean sendIS, @NotNull String aString) {
        LOGGER.debug("sendIACStr {} {} {}", aCmd, TELOPT[aOpt], aString);
    ...
    protected synchronized void caughtIOException(IOException ex) {
        LOGGER.debug("IOException is caught", ex);
